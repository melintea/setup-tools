# $Id: //users/aurelian.melinte_systest/config/sipr/controllers/testFaxReinvite_1329_controller.rb#1 $
# $Change: 157759 $
...
class TestFaxReinvite_1329_Controller < ININ::BaseGWController
